...
import random
#def facedet(img):
face_cascade = cv2.CascadeClassifier('G:\MajorProje\haarcascade_frontalface_default.xml')
eye_cascade = cv2.CascadeClassifier('G:\MajorProje\haarcascade_eye.xml')
mouth_cascade = cv2.CascadeClassifier('G:\MajorProje\haarcascade_mcs_mouth.xml')
#nose_cascade = cv2.CascadeClassifier('G:\MAJOR PROJECt\haarcascade_mcs_nose.xml')
m1=0
array=[]
array1=[]
array2=[]
...
def testingSet():
    ...
    file.write((str)(a1))
    file.close()
    newpath = r'G:\MajorProje\\s'+(str)(a)
    ...
    while i<50:
        ...
        if chc==1:
            ...
            if i%3==0:
                rrr=(i/3)+1
                kkk="G:\\MajorProje\\funny\\f"+str(rrr)+".jpg"
            print "RRR"
            print rrr
            img21 = cv2.imread("G:\\MajorProje\\funny\\f"+str(rrr)+".jpg")
            #print img21
            ...
            if i%3==0:
                rrr=(i/3)+1
                kkk="G:\\MajorProje\\sad\\p"+str(rrr)+".jpg"
            print "RRR"
            print rrr
            img21 = cv2.imread("G:\\MajorProje\\sad\\p"+str(rrr)+".jpg")
            #print img21
            cv2.namedWindow('IMAGE', cv2.WINDOW_NORMAL)
            cv2.imshow('IMAGE',img21)
...
if __name__ == '__main__':
    ...
    B1.pack()
    top1.mainloop()
    file=open('G:\MajorProje\\finalResult.txt','a')
    file.write("\n"+"Type Choosen"+(str)(chcc)+" Smiling="+(str)(jj)+" "+"SHOCKED="+(str)(kk)+" Folder"+(str)(folder1))
    file.close()
    tkMessageBox.showinfo( "ASPERGER SYANDROME", "NEUTRAL"+(str)(jj)+" "+"SHOCK"+(str)(kk)+" happy"
	+" Sadness"+" Fear"+" Disgust") 
    print "Type Choosen"+(str)(chcc)+"Smiling="+(str)(jj)+" "+"SHOCKED="+(str)(kk)+"Folder"+(str)(folder1)
    time.sleep(10)
